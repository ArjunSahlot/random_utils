...
print("Installing...")
try:
    urllib.request.urlretrieve("https://github.com/ArjunSahlot/random_utils/archive/main.zip", tmp)
    file += "main"
except urllib.error.HTTPError:
    urllib.request.urlretrieve("https://github.com/ArjunSahlot/random_utils/archive/master.zip", tmp)
    file += "master"
